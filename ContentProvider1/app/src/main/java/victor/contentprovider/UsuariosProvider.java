package victor.contentprovider;
...
public class UsuariosProvider extends ContentProvider {
    ...
    private static final String uri = "content://victor.contentprovider.UsuariosProvider/usuarios";
    ...
    static {
        ...
        uriMatcher.addURI("victor.contentprovider.UsuariosProvider", "usuarios", USUARIOS);
        uriMatcher.addURI("victor.contentprovider.UsuariosProvider", "usuarios/#", USUARIOS_ID);
    }
